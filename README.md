...
Това хранилище поддържа ранния етап по изясняване и планиране на дигитален проект за туристическа агенция.
...
- подготовка на ясен начален списък със задачи за следващия етап

## Какво не представлява

Това все още не е хранилище за изпълнение на разработка.
Не представлява финален технически списък със задачи или детайлен план за реализация.
...
- Готово: приключени дейности по изясняване или планиране